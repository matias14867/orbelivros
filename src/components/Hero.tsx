    ...
    <section className="relative min-h-screen flex items-center pt-20">
      ...
      <div className="container relative z-10">
        <div className="max-w-2xl">
          ...
          >
            <Button variant="hero" size="xl" onClick={() => navigate("/livros")}>
              {texts.buttonPrimary}
              <ArrowRight className="h-5 w-5" />
            </Button>
            <Button variant="heroOutline" size="xl" onClick={() => navigate("/livros")}>
          ...
          >
            <div>
              ...
              <p className="text-primary-foreground/70 text-sm">{texts.stat1Label}</p>
            </div>
            <div>
              <p className="font-serif text-3xl md:text-4xl font-bold text-primary-foreground">
                {texts.stat2Value}
              </p>
              <p className="text-primary-foreground/70 text-sm">{texts.stat2Label}</p>
            </div>
            <div>
              <p className="font-serif text-3xl md:text-4xl font-bold text-primary-foreground">
                {texts.stat3Value}
              </p>
              <p className="text-primary-foreground/70 text-sm">{texts.stat3Label}</p>
            </div>
          </div>
        </div>
      </div>
